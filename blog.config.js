...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Aedream', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.aedream.eu.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '个人网站,博客', // 网站关键词 英文逗号隔开
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/logo.png', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Aedream BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
